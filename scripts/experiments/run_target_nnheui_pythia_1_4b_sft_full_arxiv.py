"""MIA experiment: nnheui/pythia-1.4b-sft-full (Main + Control)

Target : nnheui/pythia-1.4b-sft-full
...
Run from the repo root:
    python scripts/experiments/run_target_nnheui_pythia_1_4b_sft_full.py
"""
...
TARGET_SLUG   = "nnheui_pythia_1_4b_sft_full"
