"""MIA experiment: lomahony/eleuther-pythia12b-hh-sft (Main + Control)

Target : lomahony/eleuther-pythia12b-hh-sft
...
Run from the repo root:
    python scripts/experiments/run_target_lomahony_pythia_12b_hh_sft.py
"""
...
# Configuration
# ------------------------------------------------------------------ #
TARGET_MODEL  = "lomahony/eleuther-pythia12b-hh-sft"
TARGET_SLUG   = "lomahony_pythia_12b_hh_sft"
