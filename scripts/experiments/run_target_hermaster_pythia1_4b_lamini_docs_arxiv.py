"""MIA experiment: herMaster/pythia1.4B-finetuned-on-lamini-docs (Main + Control)

Target : herMaster/pythia1.4B-finetuned-on-lamini-docs
...
Run from the repo root:
    python scripts/experiments/run_target_hermaster_pythia1_4b_lamini_docs.py
"""
...
TARGET_SLUG   = "hermaster_pythia1_4b_lamini_docs"
