"""MIA experiment: pkarypis/pythia-ultrachat (Main + Control)

Target : pkarypis/pythia-ultrachat
...
# Configuration
# ------------------------------------------------------------------ #
TARGET_MODEL  = "pkarypis/pythia-ultrachat"
TARGET_SLUG   = "pkarypis_pythia_ultrachat"
