"""MIA experiment: lomahony/eleuther-pythia6.9b-hh-dpo (Main + Control)

Target : lomahony/eleuther-pythia6.9b-hh-dpo
...
Run from the repo root:
    python scripts/experiments/run_target_lomahony_pythia_6_9b_hh_dpo.py
"""
...
# Configuration
# ------------------------------------------------------------------ #
TARGET_MODEL  = "lomahony/eleuther-pythia6.9b-hh-dpo"
TARGET_SLUG   = "lomahony_pythia_6_9b_hh_dpo"
