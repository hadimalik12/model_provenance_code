"""MIA experiment: lomahony/pythia-1.4b-helpful-sft (Main + Control)

Target : lomahony/pythia-1.4b-helpful-sft
...
Run from the repo root:
    python scripts/experiments/run_target_lomahony_pythia_1_4b_helpful_sft.py
"""
...
TARGET_SLUG   = "lomahony_pythia_1_4b_helpful_sft"
