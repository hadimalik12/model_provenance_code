"""MIA experiment: lomahony/pythia-1.4b-helpful-dpo (Main + Control)

Target : lomahony/pythia-1.4b-helpful-dpo
...
Run from the repo root:
    python scripts/experiments/run_target_lomahony_pythia_1_4b_helpful_dpo.py
"""
...
# Configuration
# ------------------------------------------------------------------ #
TARGET_MODEL  = "lomahony/pythia-1.4b-helpful-dpo"
TARGET_SLUG   = "lomahony_pythia_1_4b_helpful_dpo"
...
PARENT_RESULTS  = "outputs/runs/mimir_arxiv_pythia_1_4b_mink/results.json"
