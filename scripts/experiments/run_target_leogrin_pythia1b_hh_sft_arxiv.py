"""MIA experiment: Leogrin/eleuther-pythia1b-hh-sft (Main + Control)

Target : Leogrin/eleuther-pythia1b-hh-sft
...
Run from the repo root:
    python scripts/experiments/run_target_leogrin_pythia1b_hh_sft.py
"""
...
# Configuration
# ------------------------------------------------------------------ #
TARGET_MODEL  = "Leogrin/eleuther-pythia1b-hh-sft"
TARGET_SLUG   = "leogrin_pythia1b_hh_sft"
...
PARENT_RESULTS  = "outputs/runs/mimir_arxiv_pythia_1b_mink/results.json"
...
def main() -> None:
    ...
    if not os.path.isfile(os.path.join(REPO_ROOT, PARENT_RESULTS)):
        ...
        print("Run scripts/experiments/run_parent_pythia_1b_arxiv.py first.")
        sys.exit(1)
