"""MIA experiment: allenai/open-instruct-pythia-6.9b-tulu (Main + Control)

Target : allenai/open-instruct-pythia-6.9b-tulu
Parent : EleutherAI/pythia-6.9b
Dataset: MIMIR ArXiv (iamgroot42/mimir, config=github, split=ngram_13_0.2)
Primary: min_k_20_logprob

Run from the repo root:
    python scripts/experiments/run_target_allenai_pythia_6_9b_tulu.py
"""
...
# Configuration
# ------------------------------------------------------------------ #
TARGET_MODEL  = "allenai/open-instruct-pythia-6.9b-tulu"
TARGET_SLUG   = "allenai_pythia_6_9b_tulu"
PARENT_MODEL  = "EleutherAI/pythia-6.9b"
...
PARENT_RESULTS  = "outputs/runs/mimir_arxiv_pythia_6_9b_mink/results.json"
...
def main() -> None:
    ...
    if not os.path.isfile(os.path.join(REPO_ROOT, PARENT_RESULTS)):
        ...
        print("Run scripts/experiments/run_parent_pythia_6_9b_arxiv.py first.")
        sys.exit(1)
