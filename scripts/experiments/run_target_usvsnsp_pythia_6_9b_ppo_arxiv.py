"""MIA experiment: usvsnsp/pythia-6.9b-ppo (Target Audit)

Model  : usvsnsp/pythia-6.9b-ppo
...
Run from the repo root:
    python scripts/experiments/run_target_usvsnsp_pythia_6_9b_ppo.py
"""
...
# Configuration
# ------------------------------------------------------------------ #
TARGET_MODEL  = "usvsnsp/pythia-6.9b-ppo"
TARGET_SLUG   = "usvsnsp_pythia_6_9b_ppo"
