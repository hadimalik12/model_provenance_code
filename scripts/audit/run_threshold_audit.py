...
Reads scored train/test JSONL files (output of score_causal_lm_logprobs.py),
...
from src.shard_audit.auditing.distinguishers import run_distinguisher, evaluate_at_threshold, safe_auc, tpr_at_fpr
...
def _write_report(
    ...
    report_lines = [
        ...
        "```bash",
        f"# Data preparation",
        f"python scripts/data/prepare_mimir_domain.py \\",
        ...
        "",
        f"# Scoring",
        f"python scripts/scoring/score_causal_lm_logprobs.py \\",
