...
Usage:
    python experiments/table_02_target_provenance/reports/compare_parent_target.py \\
        ...
        --target-model herMaster/pythia1.4B-finetuned-on-lamini-docs \\
...
def parse_args():
    ...
    p.add_argument("--target-model", default="herMaster/pythia1.4B-finetuned-on-lamini-docs")
