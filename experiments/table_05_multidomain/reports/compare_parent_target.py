...
Usage:
    python experiments/table_05_multidomain/reports/compare_parent_target.py \\
...
def main():
    ...
    lines += [
        ...
        f"- **Target model:** `{TARGET_MODEL}` (fine-tuned on Lamini Docs)",
    ...
    lines += [
        ...
        "---",
        "",
        f"*Report generated by `experiments/table_05_multidomain/reports/compare_parent_target.py` "
        f"at {now_utc}.*",
    ]
