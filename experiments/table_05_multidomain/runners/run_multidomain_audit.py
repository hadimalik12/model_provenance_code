...
Usage:
    python scripts/experiments/run_mimir_multi_domain_experiment.py \\
        ...
        --models EleutherAI/pythia-1.4b,herMaster/pythia1.4B-finetuned-on-lamini-docs \\
        --model-slugs parent_pythia_1_4b,target_hermaster_pythia1_4b_lamini_docs \\
...
def parse_args():
    ...
    p.add_argument("--models",
                   default="EleutherAI/pythia-1.4b,herMaster/pythia1.4B-finetuned-on-lamini-docs")
