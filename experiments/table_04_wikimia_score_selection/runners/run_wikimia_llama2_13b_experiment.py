...
def _extract_logprobs_auto(texts: list, model, tokenizer, max_length: int) -> list:
    ...
    input_ids = encodings["input_ids"].to(device=input_device, dtype=torch.long)
...
def main():
    ...
    print(f"\nNext step:")
    print(f"  python experiments/table_04_wikimia_score_selection/reports/llama2_13b.py \\")
